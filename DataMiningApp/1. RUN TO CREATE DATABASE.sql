...
/****** Object:  Database [DMP]    Script Date: 05/11/2010 04:07:48 ******/
CREATE DATABASE [DMP] ON  PRIMARY 
( NAME = N'DMP', FILENAME = N'C:\dataminingproject\DataMiningApp\App_Data\DMP.mdf' , SIZE = 2048KB , MAXSIZE = UNLIMITED, FILEGROWTH = 1024KB )
 LOG ON 
( NAME = N'DMP_log', FILENAME = N'C:\dataminingproject\DataMiningApp\App_Data\DMP_log.ldf' , SIZE = 1024KB , MAXSIZE = 2048GB , FILEGROWTH = 10%)
GO
